...
*/
public class NonGraded extends Observable 
{
    public static void main(String[] args) throws Exception 
    {
        NonGraded ap = new NonGraded(args);
    }
    ...
    public NonGraded(String[] args, Observer ob) throws Exception
    {
    	usedAsLibrary = true;
    	configure(args);
    	this.addObserver(ob);
...
*/
    public NonGraded(String[] args) throws Exception
    {
        configure(args);
        go();
    }
    ...
    private void createNewItemsetsFromPreviousOnes()
    {
        ...
        for(int i=0; i<itemsets.size(); i++)
        {
            for(int j=i+1; j<itemsets.size(); j++)
            {
                ...
                int [] Cand = new int[currentSizeOfItemsets+1];
                ...
                if (ndifferent==1) {
                	...
                	Arrays.sort(Cand);
                	tempCandidates.put(Arrays.toString(Cand), Cand);
                }
            }
        }
